...
import { UnitWhModel, WarehouseService } from '../../../../../services/warehouse-service.service';
...
export class UnitIndexComponent {
  ...
  list() {
    ...
    this._warehouseService.listUnit({
  ...
  edit(id: string | undefined) {
    this.router.navigate(["/unit/update/", id]);
  }
  ...
  delete(id: string | undefined) {
    this.router.navigate(["/unit/delete/", id]);
  }
}
